...
public class Test3Streams {
	...
	public static void main(String[] args) {
		...
		List<String> strings = Arrays.asList("abc", "", "ac", "efg", "abcd", "", "jkl");
		System.out.println("List: " + strings);

		long count = getCountEmptyStringUsingJava7(strings);

		System.out.println("Empty Striing:" + count);
		...
		// Eliminate empty string and join by comma
